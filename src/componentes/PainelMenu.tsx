    ...
    >
      ...
      <div className="flex items-center justify-center gap-2.5">
        <input
          ...
          className="w-full max-w-xs rounded-lg border border-slate-300 bg-white px-4 py-3 text-center text-lg text-slate-900 placeholder:text-slate-500 focus:border-sky-700 focus:outline-none focus:ring-2 focus:ring-sky-600/30"
        />
        <button
          type="button"
